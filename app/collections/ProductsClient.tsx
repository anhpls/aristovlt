      ...
      <div className="min-h-full bg-stone-200 py-10 pt-28">
        <div className="w-full h-full flex justify-center items-center">
          <div className="text-center shadow-neutral-400 shadow-inner py-14 flex-col  bg-black bg-opacity-10 rounded-sm w-full ">
            ...
            <p className="text-xs md:text-sm text-stone-600 font-semibold capitalize md:mt-2">
              Shop all the pieces
            </p>
          </div>
        </div>
        ...
        <div className="min-h-screen mb-44">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-20 md:gap-x-4 md:gap-y-28 mt-24 px-20 h-full auto-rows-[1fr] ">
